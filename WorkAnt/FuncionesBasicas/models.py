...
class historialConsulta(models.Model):
    ...
    llaveForaneaEmpleadores = models.ForeignKey(
        Empleadores, on_delete=models.CASCADE,)
 #===================================================#
