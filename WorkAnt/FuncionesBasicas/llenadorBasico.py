...
class llenadorTablas(self):
    ...
    def llenadorTablasTarjetas(self, empleado_id , ptimempoDisponible,  pzona, ptagBusqueda):
        ...
        tarjeta=TarjetaTrabajo(llaveForanea=empleado,tiempoDisponible=ptimempoDisponible , zona=pzona)
        tarjeta.save()
    ...
    def llenadorTablasHistorialConsulta(self, tarjeta_id, empleador_id):
        ...
        hcreacion=historialConsulta(llaveForaneaTarjeta=tarjeta, llaveForaneaEmpleadores=empleador)
        hcreacion.save()